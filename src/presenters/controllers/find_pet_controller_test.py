...
def test_route():
    ...
    assert find_pet_use_case.by_pet_id_and_user_id_param["pet_id"] == attributes["pet_id"]
    assert find_pet_use_case.by_pet_id_and_user_id_param["user_id"] == attributes["user_id"]
